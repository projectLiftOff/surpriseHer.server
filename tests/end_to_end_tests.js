...
test("new user does partial sign up on site", t => {
  ...
  .end((_, data) => {
    ...
    const beforeBetaLaunchTxt = "Hi, this is SurpriseHer, we’re excited you signed up! We’re a simple way to keep the spark alive and remind her she’s special. You will receive a text early January with our first-ever gift list. You can start surprising her as early as next month!"
    t.deepEqual(
