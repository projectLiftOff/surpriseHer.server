...
test("new user does partial sign up on site", t => {
  ...
  .end((_, data) => {
    ...
    const beforeBetaLaunchTxt = "Hi, this is SurpriseHer, we’re excited you signed up! We’re a simple way to keep the spark alive and remind her she’s special. You will receive a text mid 2016 with our first-ever gift list. If you have any questions feel free to reach out to us here: hello@surpriseher.co"
    t.deepEqual(
